...
Public Class MonthlySalesReportForm
    ...
    Private Sub btnQuery_Click(sender As Object, e As EventArgs) Handles btnQuery.Click
        Try
            ...
            Dim sql As String = $"SELECT DATE_FORMAT(a.creationtime, '%Y-%m') AS yuefen, h.title AS kufang, " &
                ...
                "GROUP BY DATE_FORMAT(a.creationtime, '%Y-%m'), a.kufang " &
                "ORDER BY yuefen DESC, h.title"
