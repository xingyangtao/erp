...
Public Class MonthlySummarySalesForm
    ...
    Private Sub btnQuery_Click(sender As Object, e As EventArgs) Handles btnQuery.Click
        Try
            ...
            Dim sql As String = $"SELECT DATE_FORMAT(a.creationtime, '%Y-%m') AS yuefen, " &
                ...
                "GROUP BY DATE_FORMAT(a.creationtime, '%Y-%m') " &
