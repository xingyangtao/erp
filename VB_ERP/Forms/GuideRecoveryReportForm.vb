...
Public Class GuideRecoveryReportForm
    ...
    Private Sub btnQuery_Click(sender As Object, e As EventArgs) Handles btnQuery.Click
        Try
            ...
            Dim sql As String = $"SELECT a.shopping_guide AS zhanghu, m.name AS daogou, h.title AS kufang, " &
                "SUM(a.jin_zhong) AS jinzhong, SUM(a.retreat_amount) AS huishou " &
                ...
                $"AND m.department IN ({UserShopPermission}) " &
                "GROUP BY a.shopping_guide " &
                "ORDER BY h.title, m.name"
