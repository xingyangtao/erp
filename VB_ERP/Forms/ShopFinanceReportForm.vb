...
Public Class ShopFinanceReportForm
    ...
    Private Sub btnQuery_Click(sender As Object, e As EventArgs) Handles btnQuery.Click
        Try
            ...
            Dim sql As String = $"SELECT DATE_FORMAT(a.creationtime, '%Y-%m-%d') AS date, h.title AS kufang, " &
                "SUM(CASE WHEN a.type='收入' THEN a.amount ELSE 0 END) AS shouru, " &
                "SUM(CASE WHEN a.type='支出' THEN a.amount ELSE 0 END) AS zhichu, " &
                "SUM(CASE WHEN a.type='收入' THEN a.amount ELSE -a.amount END) AS heji " &
                ...
                "GROUP BY DATE_FORMAT(a.creationtime, '%Y-%m-%d'), a.kufang " &
                "ORDER BY date DESC, h.title"
