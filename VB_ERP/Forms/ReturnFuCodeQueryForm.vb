' ============================================================================
' 商品退库副编码查询窗口
' 功能: 退库副编码查询（一个编码对应多个商品）
' ============================================================================

Imports MySql.Data.MySqlClient
Imports System.Data

Public Class ReturnFuCodeQueryForm
    ...
    Public SelectedProductCode As String = ""

    ' ========== 构造函数 ==========
    Public Sub New()
        Me.warehouseId = UserDepartment
        InitializeUI()
    End Sub
    ...
    Private Sub InitGrid()
        ...
        dgvList.Columns("product_name").Width = 200
    End Sub
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        Try
            Dim sql As String = "SELECT a.poduct_code, b.fu_code, CASE WHEN a.kufang='0' THEN '总库' ELSE c.title END AS kufang, " &
                "a.quantity, a.jinzhong, b.creationtime, b.product_name " &
                ...
                "WHERE a.kufang = '" & warehouseId & "' AND (a.quantity > 0 OR a.jinzhong > 0) " &
                "AND (b.poduct_code = '" & SafeSQL(txtCode.Text.Trim()) & "' OR b.fu_code = '" & SafeSQL(txtCode.Text.Trim()) & "') " &
                "ORDER BY a.id DESC"
    ...
    Private Sub DgvList_DoubleClick(sender As Object, e As EventArgs) Handles dgvList.DoubleClick
        If dgvList.SelectedRows.Count > 0 Then
            SelectedProductCode = SafeString(dgvList.SelectedRows(0).Cells("poduct_code").Value)
